...
function Cotizador() {
  ...
  // Cargar JSON
  useEffect(() => {
    fetch("/assets/json/dormitorios.json")
      .then((res) => res.json())
        ...
        <div className="block-content">
          <div className="d-grid-2-1fr gap-10">
            <div className="d-flex-column gap-10">
              ...
              {lineaSeleccionada && adicionales["base-encajonada"] && (
                <div className="cotizador-fieldset">
                  <div className="base-encajonada h-100 bg-white">
                    ...
                    <input
                      type="checkbox"
                      checked={baseEncajonada}
                      onChange={(e) => setBaseEncajonada(e.target.checked)}
                      disabled={baseEncajonadaLocked}
                    />
                  </div>
                  <button
                    type="button"
                    onClick={() => setBaseEncajonadaLocked(!baseEncajonadaLocked)}
                  >
                ...
                <div className="cotizador-fieldset">
                  <div className="d-flex-column">
                    ...
                    <input
                      ...
                      onChange={(e) => setCantidadCajones(Number(e.target.value))}
                      disabled={cantidadCajonesLocked}
                    />
                  </div>
                  <button
                    type="button"
                    onClick={() => setCantidadCajonesLocked(!cantidadCajonesLocked)}
                  >
              ...
              {categoria === "dormitorio" && producto && producto.colchón &&
                renderSelectWithLock(
                  "Colchón",
                  colchon,
                  setColchon,
              ...
              {producto && producto.complementos &&
                renderSelectWithLock(
                  "Veladores",
                  veladores,
                  setVeladores,
