...
//                     const productResponse = await fetch(`/assets/json/categorias/${categoria}/sub-categorias/${subcatNombre}.json`);
...
function PaginaDeCategoria(){
    ...
    const [productosFiltradosPorFiltros, setProductosFiltradosPorFiltros] = useState([]);
    const [isLoading, setIsLoading] = useState(true);
    // Nuevo estado para SKUs en oferta
                                            ...
                                            {currentProducts.map((producto) => {
                                                ...
                                                return(
                                                    <Producto 
                                                        ...
                                                        skusOfertas={skusOfertas} // Ahora definido
                                                    />
                                                );
                                            })}
                                        </ul>
