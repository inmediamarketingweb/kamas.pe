    ...
    return(
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://kamas.pe/assets/imagenes/paginas/pagina-principal/homepage-video.webp"/>
            </Helmet>
                ...
                <div className="block-container">
                    <section className="block-content">
                        <div className="d-flex-column gap-10">
                            <img src="/assets/imagenes/paginas/nosotros/banner.webp" alt="" className="page-banner-img"/>

                            <h1 className="block-title d-flex margin-right">Nosotros</h1>

                            <ul className="list-simple gap-10 bg-component padding-10 border-r-6">
                            ...
                            <div className="d-grid-2-1fr gap-10">
                                <div className="d-flex-column gap-10 bg-component padding-10 border-r-6">
