                ...
                <nav className='categories'>
                    <li>
                        <a href='/productos/dormitorios/' className='' title=''>
                            <img src='/assets/imagenes/paginas/pagina-principal/categorias/dormitorios.png' alt='' />
                    ...
                    <li>
                        <a href='/productos/camas-box-tarimas/' className='' title=''>
                            <img src='/assets/imagenes/paginas/pagina-principal/categorias/camas-box-tarimas.png' alt='' />
                            <p className='title'>Camas box tarimas</p>
                        </a>
                    </li>
                    <li>
                        <a href='/productos/camas-funcionales/' className='' title=''>
                            <img src='/assets/imagenes/paginas/pagina-principal/categorias/camas-funcionales.png' alt='' />
                            <p className='title'>Camas funcionales</p>
                        </a>
                    </li>
                    <li>
                        <a href='/productos/cabeceras/' className='' title=''>
                            <img src='/assets/imagenes/paginas/pagina-principal/categorias/cabeceras.png' alt='' />
                            <p className='title'>Cabeceras</p>
                        </a>
                    </li>
                    <li>
                        <a href='/productos/sofas/' className='' title=''>
                            <img src='/assets/imagenes/paginas/pagina-principal/categorias/sofas.png' alt='' />
