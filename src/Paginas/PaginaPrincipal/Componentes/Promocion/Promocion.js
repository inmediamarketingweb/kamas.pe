    ...
    return(
        <section className='block-container featured-product-container'>
            <div className='block-content featured-product-content'>
                ...
                <img src="https://www.kamas.pe/assets/imagenes/productos/dormitorios/americanos/king/der-prinz/pedestales/coronas/brazos-rectos/otros-modelos/1/1.jpg" alt='DORMITORIO KAMAS AMERICANO KING CON PIECERA + COLCHÓN SUPER ORTOPÉDICO KAMAS DER PRINZ + CABECERA PEDESTAL CORONA - CHAMPAGNE' />
            </div>
        </section>
    )
}
