...
//     return(
//         <>
//             <div className='filtros-layer'></div>

//             <div className='filtros-container-global d-flex-column'>
//                 <div className='filtros-container'>
//                     <div className='filtros-top d-flex-column'>
//                         <button type='button' className='filtros-button-close margin-left'>
...
function Filtros({ onCambiarPrecio, isOpen, onClose }){
    ...
    // Efecto para cerrar al presionar Escape
    useEffect(() => {
