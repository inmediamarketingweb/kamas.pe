...
// //     const activeDuration = 0 * 60 * 60 * 24 * 1000;
...
//             if (diffInMs <= 0) {
//                 onExpire  && onExpire();
//                 onTerminar && onTerminar(); // Llamar a onTerminar cuando el tiempo se agote
...
//         if (currentCycle.phase === 'resting') {
//             onExpire && onExpire();
//             onTerminar && onTerminar(); // Llamar a onTerminar si ya está en fase resting
//         } else{
